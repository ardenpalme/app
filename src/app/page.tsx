...
import { Presentation, Store, LayoutDashboard, ArrowRight, Check, BarChart3, Eye, MapPin, TrendingUp, Users, Shield, ShieldCheck, ImageIcon } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900">
                Digital Signage Advertising with
                <span className="text-blue-600"> Advanced Analytics </span>
              </h1>

              <div>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Create captivating ads that really sell. 
                </p>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Run them when the right person is looking.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 -left-6 transform -translate-y-1/2 bg-white rounded-lg shadow-lg p-4 border border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900"> Improve Ads </div>
                    <div className="text-xs text-gray-500"> Generative AI </div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 mx-6">
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center space-x-4 md:flex-col md:space-x-0 md:items-start">
            ...
            <div className="flex-grow space-y-3 md:space-y-0">
              <CardTitle className="md:py-2">Advanced Audience Measurement</CardTitle>
              <CardDescription>
                Understand viewer audience trends. When is your ideal customer most likely to be in front of the screen?
              </CardDescription>
            </div>
          </CardHeader>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center space-x-4 md:flex-col md:space-x-0 md:items-start">
            ...
            <div className="flex-grow space-y-3 md:space-y-0">
              <CardTitle className="md:py-2"> Privacy-Safe Design </CardTitle>
              <CardDescription>
                Digital Signage audience data never leaves the media player.
                We only analyze trends.
              </CardDescription>
            </div>
          </CardHeader>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center space-x-4 md:flex-col md:space-x-0 md:items-start">
            ...
            <div className="flex-grow space-y-3 md:space-y-0">
              ...
              <CardDescription>
                Find out who is actually buying your product; what kind of person are they?
              </CardDescription>
            </div>
          </CardHeader>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center space-x-4 md:flex-col md:space-x-0 md:items-start">
            ...
            <div className="flex-grow space-y-3 md:space-y-0">
              <CardTitle className="md:py-2">Dynamic Scheduling</CardTitle>
              <CardDescription>
                Ads are scheduled based on viewer audience trends so that the right person sees the right ad. 
              </CardDescription>
            </div>
          </CardHeader>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader className="flex flex-row items-center space-x-4 md:flex-col md:space-x-0 md:items-start">
            ...
            <div className="flex-grow space-y-3 md:space-y-0">
              <CardTitle className="md:py-2">Generative AI Ads</CardTitle>
              <CardDescription>
                Precise ad suggestions to reach your target audience. No Guesswork.
              </CardDescription>
            </div>
          </CardHeader>
        </Card>
